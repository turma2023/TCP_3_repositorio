...
public class Controlador_de_armas : NetworkBehaviour
{
    ...
    public void CromprarArma(ScriptableObject_de_armas arma)
    {
        if (arma == null)
        {
            Debug.LogError("Arma n�o pode ser comprada porque � nula.");
            return;
        }
        ...
        {
            Debug.Log("N�o h� mais espa�o para armas.");
        }
    }
    ...
    private void TrocarArma(ScriptableObject_de_armas novaArma)
    {
            ...
            if (armaAtual == novaArma) return; // Evita recria��o da mesma arma
            ...
            if (novaArma != null)
            {
                ...
                // Define a rota��o do modelo para ignorar a rota��o do pai
